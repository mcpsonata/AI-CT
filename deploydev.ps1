...
param(
    ...
    [string]$ContainerName = "aictinstancedev",
    [string]$RegistryName = "aictregistrydev",
    ...
    [string]$LogAnalyticsWorkspaceName = "AICTLogAnalyticsdev",
...
Write-Host "   • Port: 80 (HTTP - for Application Gateway backend)" -ForegroundColor White
...
if ($LASTEXITCODE -eq 0) {
    ...
    if ($containerInfo.ipAddress.fqdn) {
        ...
        Write-Host ""
        Write-Host "AICT DEV (Windows) is deployed as HTTP backend!" -ForegroundColor Green
        Write-Host "==========================================" -ForegroundColor Green
        Write-Host "Backend Application: http://$fqdn" -ForegroundColor Cyan
        Write-Host "Health Check: http://$fqdn/api/health" -ForegroundColor Cyan
        Write-Host "NOTE: This is an HTTP backend for Application Gateway" -ForegroundColor Yellow
        Write-Host "Configure Application Gateway for HTTPS public access" -ForegroundColor Yellow
